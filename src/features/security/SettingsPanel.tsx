import { ArrowLeft, CheckCircle2, Clock, ShieldCheck, Trash2, XCircle } from 'lucide-react'
      ...
      <div className="mx-auto max-w-3xl space-y-8">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            控制 Flydex 运行 Codex 时的沙箱级别与审批策略。所有更改即时保存并生效，无需手动保存。
          </p>
        </div>
            ...
            {SANDBOX_MODES.map((m) => {
              ...
              return (
                ...
                >
                  ...
                  {active && <div className="mt-2 text-xs font-medium text-primary">当前启用</div>}
                </button>
              )
            })}
          </div>
